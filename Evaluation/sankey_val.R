temp <- merge(data.frame(id=actual_ids_val$ids_k1, r1=ite_k1_val > 0, a1=actual_ttts_val$a1),
      data.frame(id=actual_ids_val$ids_k2, r2=ite_k2_val>0), by="id", all.x = TRUE)
...
temp <- merge(temp, data.frame(id=actual_ids_val$ids_k3, r3=ite_k3_val > 0, a3=actual_ttts_val$a3), by="id", all.x = TRUE)
...
library(htmlwidgets)
#htmlwidgets::saveWidget(widget = pl, file="sankey_val_bunfix.html")
